# Gantryland 0.3.0 release audit
...
- Added monorepo release support improvements: CI changeset guard workflow, `release:status`/`release:guard:changeset` scripts, and `docs/releasing/process.md` bump policy.
