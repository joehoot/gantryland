# Package Docs Authoring Guide

Use this guide to write or update package documentation files in Gantryland, especially package `README.md` files. The reference standard is `packages/task/README.md`. Aim for enterprise-grade clarity, fast onboarding, and precise behavior descriptions.
