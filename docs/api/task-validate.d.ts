 ...
 * ```
 */
export declare const fromSafeParse: <T>(safeParse: (input: unknown) => {
    success: boolean;
    data?: T;
    error?: unknown;
}) => Validator<T>;
 ...
 * ```
 */
export declare const fromPredicate: <T>(predicate: (input: unknown) => input is T, error?: unknown) => Validator<T>;
